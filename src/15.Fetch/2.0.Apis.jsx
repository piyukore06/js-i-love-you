...
function SubHeading() {
  return (
    <div className="centered heading">
      <Heading className="underline">API (Application Programming Interface)</Heading>
      <Text>Most APIs have several methods, or operations, that allow developers to create, retrieve, update, and delete data</Text>
    </div>
  );
}
